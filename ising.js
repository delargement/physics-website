// https://github.com/mattbierbaum/ising.js/

// all the global variables for dynamics
var gpx_black = null;
var gpx_white = null;
var gpx_size = 0;
var canvasN = 512;
...
function update_field(){
    ...
    document.getElementById('label_field').innerHTML = toFixed(gfield,3);
    calculateFlipTable(gT, gfield);
    reset_measurements();
}
...
function change_num(){
    ...
    document.getElementById('label_changenum').innerHTML = Math.pow(2,gN).toString().padStart(3,' ');
    init_board(Math.pow(2,gN), null);
}
